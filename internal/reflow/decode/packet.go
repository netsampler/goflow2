...
// parsePacketTuple extracts the minimum packet metadata the processor and sFlow
// decoder need for canonical flow fields.
...
// parseIPv4Tuple reads IPv4 addresses, protocol, and TCP/UDP ports when present.
...
// parseIPv6Tuple reads IPv6 addresses, next header, and TCP/UDP ports from a
// simple non-extension-header packet view.
