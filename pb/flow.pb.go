...
type FlowMessage_InnerFamily int32

const (
	FlowMessage_IPV4 FlowMessage_InnerFamily = 0
	FlowMessage_IPV6 FlowMessage_InnerFamily = 1
)

// Enum value maps for FlowMessage_InnerFamily.
var (
	FlowMessage_InnerFamily_name = map[int32]string{
		0: "IPV4",
		1: "IPV6",
	}
	FlowMessage_InnerFamily_value = map[string]int32{
		"IPV4": 0,
		"IPV6": 1,
	}
)

func (x FlowMessage_InnerFamily) Enum() *FlowMessage_InnerFamily {
	p := new(FlowMessage_InnerFamily)
	*p = x
	return p
}

func (x FlowMessage_InnerFamily) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (FlowMessage_InnerFamily) Descriptor() protoreflect.EnumDescriptor {
	return file_flow_proto_enumTypes[1].Descriptor()
}

func (FlowMessage_InnerFamily) Type() protoreflect.EnumType {
	return &file_flow_proto_enumTypes[1]
}

func (x FlowMessage_InnerFamily) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use FlowMessage_InnerFamily.Descriptor instead.
func (FlowMessage_InnerFamily) EnumDescriptor() ([]byte, []int) {
...
type FlowMessage struct {
	...
	InnerFamily              FlowMessage_InnerFamily `protobuf:"varint,160,opt,name=innerFamily,proto3,enum=flowpb.FlowMessage_InnerFamily" json:"innerFamily,omitempty"`
	InnerFrameSrcAddr        []byte                  `protobuf:"bytes,161,opt,name=innerFrame_src_addr,json=innerFrameSrcAddr,proto3" json:"innerFrame_src_addr,omitempty"`
	InnerFrameDstAddr        []byte                  `protobuf:"bytes,162,opt,name=innerFrame_dst_addr,json=innerFrameDstAddr,proto3" json:"innerFrame_dst_addr,omitempty"`
	InnerFrameProto          uint32                  `protobuf:"varint,163,opt,name=innerFrame_proto,json=innerFrameProto,proto3" json:"innerFrame_proto,omitempty"`
	InnerFrameSrcPort        uint32                  `protobuf:"varint,164,opt,name=innerFrame_src_port,json=innerFrameSrcPort,proto3" json:"innerFrame_src_port,omitempty"`
	InnerFrameDstPort        uint32                  `protobuf:"varint,165,opt,name=innerFrame_dst_port,json=innerFrameDstPort,proto3" json:"innerFrame_dst_port,omitempty"`
	InnerFrameIpv6FlowLabel  uint32                  `protobuf:"varint,166,opt,name=innerFrame_ipv6_flow_label,json=innerFrameIpv6FlowLabel,proto3" json:"innerFrame_ipv6_flow_label,omitempty"`
	InnerFrameIpTos          uint32                  `protobuf:"varint,167,opt,name=innerFrame_ip_tos,json=innerFrameIpTos,proto3" json:"innerFrame_ip_tos,omitempty"`
	InnerFrameIpTtl          uint32                  `protobuf:"varint,168,opt,name=innerFrame_ip_ttl,json=innerFrameIpTtl,proto3" json:"innerFrame_ip_ttl,omitempty"`
	InnerFrameIpFlags        uint32                  `protobuf:"varint,169,opt,name=innerFrame_ip_flags,json=innerFrameIpFlags,proto3" json:"innerFrame_ip_flags,omitempty"`
	InnerFrameTcpFlags       uint32                  `protobuf:"varint,170,opt,name=innerFrame_tcp_flags,json=innerFrameTcpFlags,proto3" json:"innerFrame_tcp_flags,omitempty"`
	InnerFrameFragmentId     uint32                  `protobuf:"varint,171,opt,name=innerFrame_fragment_id,json=innerFrameFragmentId,proto3" json:"innerFrame_fragment_id,omitempty"`
	InnerFrameFragmentOffset uint32                  `protobuf:"varint,172,opt,name=innerFrame_fragment_offset,json=innerFrameFragmentOffset,proto3" json:"innerFrame_fragment_offset,omitempty"`
	InnerFrameIcmpType       uint32                  `protobuf:"varint,173,opt,name=innerFrame_icmp_type,json=innerFrameIcmpType,proto3" json:"innerFrame_icmp_type,omitempty"`
	InnerFrameIcmpCode       uint32                  `protobuf:"varint,174,opt,name=innerFrame_icmp_code,json=innerFrameIcmpCode,proto3" json:"innerFrame_icmp_code,omitempty"`
	InnerFramePayloadLen     uint32                  `protobuf:"varint,175,opt,name=innerFrame_payload_len,json=innerFramePayloadLen,proto3" json:"innerFrame_payload_len,omitempty"`
}
...
func (x *FlowMessage) GetInnerFamily() FlowMessage_InnerFamily {
	if x != nil {
		return x.InnerFamily
	}
	return FlowMessage_IPV4
}
...
var file_flow_proto_rawDesc = []byte{
	...
	0x6f, 0x77, 0x70, 0x62, 0x22, 0xb8, 0x14, 0x0a, 0x0b, 0x46, 0x6c, 0x6f, 0x77, 0x4d, 0x65, 0x73,
	...
	,
	...
	0x03, 0x12, 0x09, 0x0a, 0x05, 0x49, 0x50, 0x46, 0x49, 0x58, 0x10, 0x04, 0x22, 0x21, 0x0a, 0x0b,
	0x49, 0x6e, 0x6e, 0x65, 0x72, 0x46, 0x61, 0x6d, 0x69, 0x6c, 0x79, 0x12, 0x08, 0x0a, 0x04, 0x49,
	...
	0x74, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x72, 0x2f, 0x67, 0x6f, 0x66, 0x6c, 0x6f, 0x77, 0x32,
...
var file_flow_proto_goTypes = []interface{}{
	...
	(FlowMessage_InnerFamily)(0), // 1: flowpb.FlowMessage.InnerFamily
...
var file_flow_proto_depIdxs = []int32{
	...
	1, // 1: flowpb.FlowMessage.innerFamily:type_name -> flowpb.FlowMessage.InnerFamily
